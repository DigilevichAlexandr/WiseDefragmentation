...
#pragma region Windows Form Designer generated code
		...
		{
			this->btGetInformation = (gcnew System::Windows::Forms::Button());
			this->comboBox1 = (gcnew System::Windows::Forms::ComboBox());
			this->listBox1 = (gcnew System::Windows::Forms::ListBox());
			this->btDefragment = (gcnew System::Windows::Forms::Button());
			this->btFileInformation = (gcnew System::Windows::Forms::Button());
			this->SuspendLayout();
			// 
			// btGetInformation
			// 
			...
			this->btGetInformation->Text = L"Информация о диске";
			this->btGetInformation->UseVisualStyleBackColor = true;
			this->btGetInformation->Click += gcnew System::EventHandler(this, &MyForm::button1_Click);
			// 
			// comboBox1
			// 
			...
			this->btDefragment->Text = L"Дефрагментировать";
			this->btDefragment->UseVisualStyleBackColor = true;
			this->btDefragment->Click += gcnew System::EventHandler(this, &MyForm::button2_Click);
			// 
			// btFileInformation
			// 
			...
			this->btFileInformation->Text = L"Информация о файле";
